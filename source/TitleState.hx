...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		backgroundTitle = new FlxSprite().loadGraphic(Paths.image('bgtitle'));
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['VS Facing Shapes by'], 15);
				// credTextShit.visible = true;
				case 3:
					addMoreText('Alot of People', 15);
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Shapes'); // credTextShit.text += '\nFunkin';
