...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...optionShit.length)
		{
			...
			var menuItem:FlxSprite = new FlxSprite(0, 150 + (i * 130));
		...
		char1 = new Character(600, -130, 'circleangry', true);
		char1.setGraphicSize(Std.int(char1.width * 0.8));
		add(char1);
		char1.visible = false;

		char2 = new Character(600, 100, 'circle', true);
		char2.setGraphicSize(Std.int(char2.width * 0.8));
		add(char2);
		char2.visible = false;

		char3 = new Character(400, 150, 'triangle', true);
		char3.setGraphicSize(Std.int(char1.width * 0.8));
		add(char3);
		char3.visible = false;	

		char4 = new Character(500, 400, 'bf', true);
